                ...
                if(mysqli_stmt_num_rows($stmt) == 1 && $UpCase == 0){                    
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                         if(password_verify($password,$hashed_password)){
                            ...
                            // $url ="PdfPac.php" . $username;
                            header("location: PdfAdm.php"); // M-AI SALVAT!!!!
                        } else{
...
<body>
    ...
    <img src="Login2.png" class="avatar">   
        ...
        <form name="loginform" id="logFORM" method="post" action="" onSubmit="died(alert($username_err))" >
            <label>Admin<span></span></label>
            <input type="text" id="CNP" name="username" placeholder="Inserati cont admin" value="<?php echo $username; ?>" >

            <label>Parola<span></span></label>
            <input type="password" id="PASS" name="password" placeholder="Inserati parola" value="" >
