                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if($password === $passwordM){
                           ...
                           // Pt localhost $url ="PdfPac.php?username=" . $username;
...
<body>
    ...
    <div class="infobox">
        ...
        <p> Acest site permite descarcarea analizelor efectuate in urma donarii sangelui. Accesul se face pe baza CNP-ului donatorului si pe baza codului de donator, format din data in care s-a efectuat donatia urmata de ultimele trei cifre ale CNP-ului. Format <span style="font-weight: bold; font-style: italic">'2019/06/05'</span></p>
    </div>
